...
export default function Tooltip({
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={`absolute z-50 px-3 py-1.5 text-sm text-white bg-gray-900 dark:bg-gray-700 rounded-lg shadow-lg whitespace-nowrap ${positionClasses[position]} animate-fade-in-up`}
          role="tooltip"
        >
          {content}
          <div
